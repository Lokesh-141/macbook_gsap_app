...
const Showcase = () => {
    ...
    useGSAP(() => {
        if (!isTablet) {
            ...
            timeline.to('.mask img', { transform: 'scale(1.1)' }).to('.content', { opacity: 1, y: 0, ease: 'power1.inOut' });
        }
    }, [isTablet])
    return (
        <section id='showcase'>
                ...
                <div className='wrapper'>
                    <div className='lg:max-w-md'>
                        ...
                        <div className='space-y-5 mt-7 pe-10'>
                            <p>Introducing {' '} <span className='text-white'> M4, the next generation of Apple silicon </span>. M4 powers</p>
